...
In the following chapters, I will try to explain basic concepts of the category theory and also show you the applications by using Typescript (since our team are mainly focusing on front-end even thought I'd love to use Haskell notations because it's much terser).
